...
interface PetPageProps {
  ...
  // Add new handlers for Cleanliness and Happiness if they have direct actions on PetPage
  // For now, we'll just navigate to inventory for these.
}
  ...
  const handleNeedClick = (needType: NeedType) => {
    ...
    switch (needType) {
      ...
      case "cleanliness":
        navigate('/inventory', {
          state: {
            targetMainCategory: 'Cleaning',
            targetSubCategory: 'BasicKit' // Default Cleaning sub-category
          }
        });
        break;
      case "happiness":
        navigate('/inventory', {
          state: {
            ...
            targetSubCategory: 'Plushie' // Default Toy sub-category
          }
        });
        break;
      case "spirit":
